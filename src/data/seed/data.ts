...
export const seedData = {
	users: [
		{ name: 'User 1', email: 'test1@google.com', password: bcryptAdapter.hash('123456') },
		{ name: 'User 2', email: 'test2@google.com', password: bcryptAdapter.hash('123456') },
		{ name: 'User 3', email: 'test3@google.com', password: bcryptAdapter.hash('123456') },
		{ name: 'User 4', email: 'test4@google.com', password: bcryptAdapter.hash('123456') },
		{ name: 'User 5', email: 'test5@google.com', password: bcryptAdapter.hash('123456') },
		{ name: 'User 6', email: 'test6@google.com', password: bcryptAdapter.hash('123456') },
	],
